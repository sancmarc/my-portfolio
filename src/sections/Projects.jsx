...
const projectsDev = [
  {
    title: "Virtu-ph.com",
    description:
      "A modern web application built with React and Next.js, enhanced with Motion for animations and Tailwind CSS for styling. Focused on creating a fast, scalable, and visually engaging digital presence for Virtu PH.",
    image: "/img/virtu/virtu-ph.png",
    tags: ["React", "Next.js", "Motion", "Tailwind CSS", "JavaScript"],
    link: "https://virtu-ph.com",
    github: "#",
  },
  {
    title: "ArtSteel.no",
    description:
      "A WordPress-based website with a custom Bootstrap template, designed to showcase steel craftsmanship in Norway. Includes social media integration, responsive layouts, and tailored content strategy for local engagement.",
    image: "/img/artsteel/artsteel-no.png",
    tags: [
      "WordPress",
      "Bootstrap",
      "Custom Template",
...
const itProfessional = [
  ...
  },
  {
    ...
    description: "Hosting A static website on AWS S3 Bucket",
  ...
  },
  {
    ...
    description: "Deploy CodeBuild in AWS Cloud",
